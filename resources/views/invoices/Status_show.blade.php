                    ...
                    <form action="{{route('Status_update',['id'=>$invoices->id])}}" method="post" enctype="multipart/form-data" autocomplete="off">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" name="invoice_number" id="invoice_number" class="form-control" title="يرجى ادخال اسم القسم"
                                        value="{{$invoices->invoice_number}}" required readonly>
                            </div>
                            <div class="col">
                                <label>تاريخ الفاتورة</label>
                                <input type="text" name="invoice_Date" class="form-control fc-datepicker" placeholder="YYYY-MM-DD" value="{{date('Y-m-d')}}" required readonly>
                            </div>
                            <div class="col">
                                <label>تاريخ الاستحقاق</label>
                                <input type="text" name="Due_date" class="form-control fc-datepicker" placeholder="YYYY-MM-DD" value="{{date('Y-m-d')}}" required readonly>
                            </div>>
                        </div>
                        {{--  2  --}}
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" name="Amount_Commission" id="Amount_Commission" class="form-control form-control-lg"
                                       title="يرجى ادخال مبلغ العمولة"  oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                            ...
                            <div class="col">
                                ...
                                <input type="text" name="Discount" id="Discount" class="form-control form-control-lg"
                                       title="يرجى ادخال مبلغ الخصم" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <textarea name="note" id="exampleTextarea" rows="3" class="form-control" readonly>{{$invoices->note}}</textarea>
                            </div>
                        </div>
                        <br>
                        <div class="col">
                        ...
                        <div class="col">
                            ...
                            <input type="text" name="Payment_Date" class="form-control fc-datepicker" placeholder="YYYY-MM-DD" required>
                        </div>
                        <div class="d-flex justify-content-center">
                            <button type="submit" class="btn btn-primary"> تحديث حالة البيانات</button>
                        </div>
